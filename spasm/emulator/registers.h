...
#define SRIP_OFFSET_BYTES  BYTES_PER_REG * SRIP_OFFSET 
#define SRSP_OFFSET_BYTES  BYTES_PER_REG * SRSP_OFFSET 
#define PTR_OFFSET_BYTES   BYTES_PER_REG * PTR_OFFSET  
#define VAL_OFFSET_BYTES   BYTES_PER_REG * VAL_OFFSET  
#define SRAX_OFFSET_BYTES  BYTES_PER_REG * SRAX_OFFSET 
#define SRBX_OFFSET_BYTES  BYTES_PER_REG * SRBX_OFFSET 
#define SRCX_OFFSET_BYTES  BYTES_PER_REG * SRCX_OFFSET 
#define SRDX_OFFSET_BYTES  BYTES_PER_REG * SRDX_OFFSET 
#define SRSI_OFFSET_BYTES  BYTES_PER_REG * SRSI_OFFSET 
#define SRDI_OFFSET_BYTES  BYTES_PER_REG * SRDI_OFFSET 
#define SRBP_OFFSET_BYTES  BYTES_PER_REG * SRBP_OFFSET 
#define SR8_OFFSET_BYTES   BYTES_PER_REG * SR8_OFFSET  
#define SR9_OFFSET_BYTES   BYTES_PER_REG * SR9_OFFSET  
#define STK_OFFSET_BYTES   BYTES_PER_REG * STK_OFFSET  
#define NUM_REGS 13
