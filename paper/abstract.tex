...
\begin{abstract}
Recently, the Spectre and Meltdown attacks have revealed serious vulnerabilities
...
communicating its results back to the rest of the payload program, changes its
behavior.
