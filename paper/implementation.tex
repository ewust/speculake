...
\begin{figure}[t]
    \centering
        \includegraphics[width=0.5\textwidth]{figures/spec_bandwidth}
    \caption{Using the speculative primitive to decrypt 1KB of data
        we have classified the speed at which data can be exfiltrated
