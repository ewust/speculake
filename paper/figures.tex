...
\begin{figure}[t]
    ...
    \caption{The number of instructions and error rate of a the 5-state Busy
            ...
            expected, the amount of time to complete a million instructions is a
            ...
            speculative calls per instruction to achieve a very low number of
            errors in reaching a million instructions, making 10-20 iterations
