...
\begin{figure}[t]
    ...
    \caption{The number of instructions and success rate of a the 5-state Busy
    Beaver configuration were measured as a function of how many iterations into
    the speculative world were performed. We see that the amount of time to
    reach 20,000 instructions completed is a linear function of how many
    indirect calls into the speculative world we take. Additionally we see that
    it only requires using 4 speculative calls per instruction to achieve no
    errors in reaching 20,000 instructions.}
