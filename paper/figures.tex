...
\begin{table}
    \centering
    \resizebox{\linewidth}{!}{\begin{tabularx}{\linewidth}{l X X| Y Y Y}
        Processor & Year\newline
        released & Micro\newline
        arch & Nested\newline 
        Spec? & Num\newline
        ...
        Intel Xeon CPU E3-1276 v3 & 2014 & Haswell &            & ?  & ?  \\
        AMD EPYC 7251             & 2017 & Ryzen   &            & ?  & ?  \\
    \end{tabularx}}
    \caption{\textbf{Processor features}--- We analyzed the capability of
    \speculake on three Intel and one AMD processor. Both Skylake processors
    ...
    desired address ($> 95\%$) while the Intel Core i5-7200U only required 26
    jumps.}
