...
outlined by~\cite{intel-rob-capacity}. We measure the maximum number of cycles taken to
...
We find that not all Intel CPUs we tried support nested speculation. For
